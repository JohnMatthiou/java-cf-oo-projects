package ch18.bankaccounts.service;

import ch18.bankaccounts.dao.IBankAccountDAO;
import ch18.bankaccounts.dto.BankAccountInsertDTO;
import ch18.bankaccounts.dto.BankAccountUpdateDTO;
import ch18.bankaccounts.dto.UserInsertDTO;
import ch18.bankaccounts.dto.UserUpdateDTO;
import ch18.bankaccounts.model.BankAccount;
import ch18.bankaccounts.model.User;
import ch18.bankaccounts.service.exceptions.*;
...
public class BankAccountServiceImpl implements IBankAccountService {
    ...
    public double withdrawFromBankAccount(String iban, double amount, String ssn) throws AccountNotFoundException, SsnNotValidException, NegativeAmountException, InsufficientBalanceException {
        ...
        } catch (AccountNotFoundException | NegativeAmountException | SsnNotValidException | InsufficientBalanceException e) {
            //logging
            throw e;
        }
    }
